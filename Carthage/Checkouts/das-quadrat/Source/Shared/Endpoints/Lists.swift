...
open class Lists: Endpoint {
    ...
    open func moveitem(_ listId: String, itemId: String, parameters: Parameters?, completionHandler: ResponseClosure? = nil) -> Task {
    ...
    open func updateitem(_ listId: String, itemId: String, parameters: Parameters?, completionHandler: ResponseClosure? = nil) -> Task {
