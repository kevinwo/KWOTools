...
open class Venues: Endpoint {
    ...
    open func add(_ name: String, ll: String, parameters: Parameters?, completionHandler: ResponseClosure? = nil) -> Task {
        let path = "add"
    ...
    open func flag(_ venueId: String, problem: String, parameters: Parameters?, completionHandler: ResponseClosure? = nil) -> Task {
    ...
    open func setrole(_ venueId: String, userId: String, role: String, parameters: Parameters?, completionHandler: ResponseClosure? = nil) -> Task {
