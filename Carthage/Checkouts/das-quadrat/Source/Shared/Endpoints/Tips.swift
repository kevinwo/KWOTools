...
open class Tips: Endpoint {
    ...
    open func add(_ venueId: String, text: String, parameters: Parameters?, completionHandler: ResponseClosure? = nil) -> Task {
        let path = "add"
    ...
    open func flag(_ tipId: String, problem: String, parameters: Parameters?, completionHandler: ResponseClosure? = nil) -> Task {
        let path = tipId + "/flag"
